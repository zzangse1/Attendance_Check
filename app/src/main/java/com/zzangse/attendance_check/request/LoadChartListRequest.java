...
public class LoadChartListRequest {
    private Context context;
    private static final String BASE_URL = "http://zzangse.store/load_chart_list.php";
    public LoadChartListRequest(Context context) {
