...
public class LoadMemberCheckRequest {
    private Context context;
    private static final String BASE_URL = "http://zzangse.store/load_member_check.php";

    public LoadMemberCheckRequest(Context context) {
    ...
    public void sendMemberOutputRequest(final int priNum, String infoDate, final VolleyCallback callback) {
