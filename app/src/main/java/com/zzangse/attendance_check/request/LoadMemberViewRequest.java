...
public class LoadMemberViewRequest {
    private Context context;
    private static final String BASE_URL = "http://zzangse.store/load_member_info.php";

    public LoadMemberViewRequest(Context context) {
    ...
    public void loadMemberViewRequest(final int priNum, final VolleyCallback callback) {
